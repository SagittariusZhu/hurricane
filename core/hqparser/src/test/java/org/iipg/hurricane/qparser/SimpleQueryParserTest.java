...
public class SimpleQueryParserTest {
	...
	@Test
	public void run() {
		//String qStr = "+content:hello +title:non";
		//String qStr = "+content:(+hello +(!non))";
		//String qStr = "content:(+hello -non)";
		//String qStr = "+reader:(zhangsan zhu) +readtime:[2014-11-01 TO 2015-01-01]";
		String qStr = "link:\"http\\://news.qq.com/a/20141206/015217.htm\"";
		SimpleQueryParser parser = new SimpleQueryParser("text");
		try {
			Query q = parser.parse(qStr);
			System.out.println(q);
			System.out.println(getMysqlSql(q));
	...
	private String getMysqlSql(Query q) throws JSONException {
