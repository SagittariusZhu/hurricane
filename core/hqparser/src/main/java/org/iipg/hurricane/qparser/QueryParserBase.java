package org.iipg.hurricane.qparser;
...
import org.iipg.hurricane.search.Query.Operator;
import org.iipg.hurricane.search.RegexpQuery.RegExp;
import org.iipg.hurricane.util.DateTool;
import org.iipg.hurricane.util.QueryBuilder;
...
public abstract class QueryParserBase extends QueryBuilder {
	...
	protected Query getFieldQuery(String field, String queryText, boolean quoted) throws ParseException {
		return newFieldQuery(field, queryText, quoted);
	}

	/**
	 * @exception org.apache.lucene.queryparser.classic.ParseException throw in overridden method to disallow
	 */
	protected Query newFieldQuery(String field, String queryText, boolean quoted)  throws ParseException {
		BooleanClause.Occur occur = operator == Operator.AND ? BooleanClause.Occur.MUST : BooleanClause.Occur.SHOULD;
		return createFieldQuery(occur, field, queryText);
	}
	...
	protected Query getRangeQuery(String field,
		...
		try {
			part1 = DateTool.dateToString(df.parse(part1));
		} catch (Exception e) { }
		...
		try {
			...
			part2 = DateTool.dateToString(d2);
		} catch (Exception e) { }
