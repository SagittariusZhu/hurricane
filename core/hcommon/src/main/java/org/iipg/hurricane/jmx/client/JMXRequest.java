...
public abstract class JMXRequest {
    ...
    private JMXTargetConfig targetConfig;
     ...
     */
    protected JMXRequest(JMXTargetConfig pTargetConfig) {
     ...
     */
    public JMXTargetConfig getTargetConfig() {
        return targetConfig;
    }
    ...
    public abstract JMXRequestHandler getRequestHandler(String serverURL);
    
	public abstract JMXResponseExtractor getResponseExtractor();
     ...
     */
    public abstract <R extends JMXResponse<? extends JMXRequest>> R createResponse(JSONObject pResponse);
