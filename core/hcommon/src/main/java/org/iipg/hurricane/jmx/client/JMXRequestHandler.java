...
/*        String method = pPreferredMethod;
     ...
     */
    public <T extends JMXRequest> HttpUriRequest getHttpRequest(List<T> pRequests,Map<JMXQueryParameter,String> pProcessingOptions)
    ...
    protected URI createRequestURI(String path,String queryParams) throws URISyntaxException {
    	return new URI(serverUrl.getScheme(),
