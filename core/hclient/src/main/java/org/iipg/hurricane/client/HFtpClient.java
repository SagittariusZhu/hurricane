...
import org.iipg.hurricane.client.response.DownloadStatus;
import org.iipg.hurricane.client.response.UploadStatus;
...
public class HFtpClient {    
	...
	public void setConnection(ICEConnection conn) {
		this.conn = conn;
	}
